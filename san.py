...
import time,random,sys,json,codecs,threading,glob,urllib,urllib2,urllib3,re,subprocess,os


cl = LINETCR.LINE()
cl.login(token="EoRxgsYBbGmEqc3Uqgya.ePXpM3e81NKzdiuCjAexQG.zJ0/Y2PAkIwnMJwwlSZRVEP10zcQHMjwNP5oR7icsEs=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Eo0BZDUvNaAidOYacmgd.KgGnVpuu4UoPTZxog8gKlq.oDUS9rbdA36O9lN/N0+F/PdF3p1KYMGJpGg53RMbKm0=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Eonhy9OT4zOEOmsJi1J4.XbemDkcGRdmfYewH8sUW5a.Q4k4RchK0BNkRBVrRW/AmT9Z6gBrUon11MNPUN9d+u4=")
kk.loginResult()

kc = LINETCR.LINE() 
kc.login(token="EoP6ydUQPm3Fv2qxMhO4.hyIG0YVMbVXiGhDgDA1Xba.OkYURFRCuFGI+KIIppr/NRP/2fLJbSIRguvfYp0aO9g=") 
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="EoC3XOTrUzjmhTFa76Y1.ZguoB0RpYTlnvzdSI0AyKq.ev/F2v9WaqPlZYPnsQIGgRPNYixKzLaiItql5fhLBP8=")
kb.loginResult()

kd = LINETCR.LINE() 
kd.login(token="EoNzSdWFNSDIL8N7tQp8.J+4Xg8PDHUX5MD/u/zYY/a.96ShBt5c3XZisBIs8iOv3WVkZA843o+9voFps1i6pn8=") 
kd.loginResult()

ke = LINETCR.LINE() 
ke.login(token="EoDqE8588ZYpjKOi7zre.AwekCIQ4q9VHwr7naq4sVG.Wwozdq+gsha+eD4GYAbADMhOQEoKXLyPwHbLH8NGsQ4=") 
ke.loginResult()

kg = LINETCR.LINE() 
kg.login(token="EoeFU9QridM52UNKTKX1.9zBpMROw512Q/mJnTa74Gq.0sLB7E9kT1oNeZWRVitmGGSrJT/ZlplEjMibHs28n8E=") 
kg.loginResult()

kh = LINETCR.LINE() 
kh.login(token="Eo9fJsfipLNhRzX113Of.9z10m8jsHnIkksCIJlOXpW.dXQJ0yK0DymkxPpu6eYPkoRx6C/huiQKWE7LoCzFlcY=") 
kh.loginResult()

sw = LINETCR.LINE()
sw.login(token="EoelRikH575PGdFurMt1.FwJGt0GBkYwYgUWmAF2Sqq.GTIsWB0V+SoAj6huTO47x3mUGSXfAX3LqBaijzs1uK8=")
sw.loginResult()
...
╚════════════
        ☞ http://line.me/ti/p/~maotaubangetapah
...
staff = ["uea937eb29a0304cb01d0f744e7e0be6c"]
owner = ["uea937eb29a0304cb01d0f744e7e0be6c"]
adminMID = 'uea937eb29a0304cb01d0f744e7e0be6c'
wait ={ 
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks for add Created by insan",
    "lang":"JP",
        ...
        if op.type == 26:
	      ...
	      if msg.from_ in admin:
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,helpt)
            elif msg.text in ["TD:restart"]:
                 cl.sendText(msg.to, "Bot nya otw restart tunggu bntr, gw tau nunggu itu gk enak")
                 restart_program()
	      ...
	      if msg.from_ in admin:
                ...
                if msg.from_ in admin:
                 ...
                 van = "       ∆BOT SUDAH DI RUNTIME SELAMA∆"+waktu(eltime)
